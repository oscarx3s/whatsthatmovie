...
<script src="Components/MovieInfo.js"></script>
			...
			<div class="row sidebarpage" id="movielib">
				...
				<div id="collapseUsers"
					...
					<div class="accordion-body" id="maccbody">
						<div class="mt-0">
							<strong>Welcome to the movie library</strong> <br>You can find all available movies here, 
							like them and rate them to find more movies that might match your taste. Good hunting!
						</div>
						<div class="movieLibGrid" id="movieLibGrid">
